...
var MPU9250_ACCELEROMETER_MASK              = 0x0238 + 0x80;
...
CC2650SensorTag.prototype.enableAccelerometer = function(callback) {
  console.log('enableAccelerometer', MPU9250_ACCELEROMETER_MASK);
...
CC2650SensorTag.prototype.enableMagnetometer = function(callback) {
  console.log('enableMagnetometer', MPU9250_MAGNETOMETER_MASK);
...
CC2650SensorTag.prototype.enableGyroscope = function(callback) {
  console.log('enableGyroscope', MPU9250_GYROSCOPE_MASK);
