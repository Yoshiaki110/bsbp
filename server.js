...
function ti_accelerometer(conned_obj, period) {
  console.info("ready: notifyAccelerometer 1");
  conned_obj.enableAccelerometer(function() {
    console.info("ready: notifyAccelerometer 2");
    conned_obj.setAccelerometerPeriod(period, function() {
      console.info("ready: notifyAccelerometer 3");
...
function ti_gyroscope(conned_obj, period) {
  console.info("ready: notifyGyroscope 1");
  conned_obj.enableGyroscope(function() {
    console.info("ready: notifyGyroscope 2");
    conned_obj.setGyroscopePeriod(period, function() {
      console.info("ready: notifyGyroscope 3");
...
function loop() {
  ...
  for (key in global.lux) {
    console.log(key + '\t' + datetimeStr() + '\t' + global.obj_temp[key] + '\t' + global.temp[key] + '\t' + global.accel_x[key] + '\t' + global.accel_y[key] + '\t' + global.accel_z[key] + '\t' +  global.gyro_x[key] + '\t' + global.gyro_y[key] + '\t' + global.gyro_z[key] + '\t' + global.hum[key] + '\t' + global.baro[key] + '\t' + global.lux[key] );
